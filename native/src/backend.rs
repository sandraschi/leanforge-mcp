...
const BACKEND_NAME: &str = "leanforge-mcp-backend.exe";
const BACKEND_PORT: u16 = 10867;
const BACKEND_TAG: &str = "leanforge-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "LEANFORGE_MCP_PORT";
const ENV_HOST: &str = "LEANFORGE_MCP_HOST";
const ENV_TAURI: &str = "LEANFORGE_MCP_TAURI";
